                      ...
                      <div className="flex flex-col gap-8">
                        <div className="flex items-center justify-between px-2">
                          <div className="flex items-center gap-4">
                            ...
                            <span className="text-sm text-neutral-300 font-bold tabular-nums tracking-widest">
                              {day.sunrise}
                            </span>
                          </div>
                          <div className="flex items-center gap-4">
                        ...
                        {day.waterTemp !== null && (
                          <div className="flex items-center gap-8 p-8 bg-cyan-950/20 border border-cyan-500/20 rounded-[2.5rem] shadow-2xl transition-all hover:bg-cyan-950/40">
                            ...
                            <div className="flex flex-col min-w-0">
                              <span className="text-[10px] text-cyan-700 font-black uppercase tracking-[0.3em] leading-none mb-2">
                                {t.weather.water}
                              </span>
